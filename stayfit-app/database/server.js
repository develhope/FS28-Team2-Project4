...
const schema = Joi.object({
  professionType: Joi.string().valid('personalTrainer', 'nutrizionista', 'entrambi').required(),
  ...
  socialNetwork: Joi.string().valid('facebook', 'instagram', 'twitter', 'linkedin').allow(''),
  subscriptionType: Joi.string().valid('Free', 'Starter', 'Premium').required(),
  taxCode: Joi.string().pattern(/^\d{11}$/).allow(''),

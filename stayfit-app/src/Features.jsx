  ...
  return (
    <section id="features" className="py-17 text-center">
      ...
      <div className="flex flex-col md:flex-row gap-4 p-10">
        <div className="bg-custom-blue bg-opacity-40 backdrop-blur-md text-white p-3 rounded-lg shadow-md flex-1">
        ...
        <div className="bg-custom-blue bg-opacity-40 backdrop-blur-md text-white p-5 rounded-lg shadow-md flex-1">

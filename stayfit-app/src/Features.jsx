    ...
    <section id="features" className="py-17 text-center">
      ...
      <div className="flex flex-col md:flex-row gap-4 p-10">
        <div className="bg-custom-blue bg-opacity-70 text-white p-3 rounded-lg shadow-md flex-1">
          <h3 className="text-2xl font-bold mb-2 text-left"><span className="text-custom-green">Custom</span> Fitness</h3>
        ...
        <div className="bg-custom-blue bg-opacity-70 text-white p-4 rounded-lg shadow-md flex-1">
          <h3 className="text-2xl font-bold mb-2 text-left"><span className="text-custom-green">Custom</span> Nutrition</h3>
        ...
        <div className="bg-custom-blue bg-opacity-70 text-white p-4 rounded-lg shadow-md flex-1">
          <h3 className="text-2xl font-bold mb-2 text-left"><span className="text-custom-green">Simpl</span>ified</h3>

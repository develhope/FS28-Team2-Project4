...
const Form = () => {
  ...
  const steps = [
      ...
      component: (
        <>
          ...
          {formData.certifications.length > 0 &&
            renderFilePreview(formData.certifications)}
        </>
      ),
    },
    {
    ...
    {
      label: "Ricevere Aggiornamenti dall'App",
      fields: [],
      component: (
        <div className="form-check">
          <input

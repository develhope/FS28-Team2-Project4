    ...
    <section id="features" className="py-17 text-center">
      ...
      <div className="flex flex-col md:flex-row gap-4 p-10">
        <div className="bg-primary-blue bg-opacity-40 backdrop-blur-md text-white p-3 rounded-lg shadow-md flex-1">
          <h3 className="text-xl font-bold mb-2 text-center md:text-left"><span className="text-secondary-green">Custom</span> Fitness</h3>
          <p className="text-left text-[15px]">Il nostro sistema genera routine su misura che
        ...
        <div className="bg-primary-blue bg-opacity-40 backdrop-blur-md text-white p-5 rounded-lg shadow-md flex-1">
          <h3 className="text-xl font-bold mb-2 text-center md:text-left"><span className="text-secondary-green">Custom</span> Nutrition</h3>
          <p className="text-left text-[15px]">Stayfit facilita la creazione di diete ecquilibrate e offre la possibilità
        ...
        <div className="bg-primary-blue bg-opacity-40 backdrop-blur-md text-white p-5 rounded-lg shadow-md flex-1">
          <h3 className="text-xl font-bold mb-2 text-center md:text-left"><span className="text-secondary-green">Simpl</span>ified</h3>
          <p className="text-left text-[15px]">Automatizza le attività quotidiane e utilizza strumenti avanzati per ottenere
